...
if __name__ == "__main__":
    ...
    annotations_file_train = '/home/pose/fashion_data/fashion-resize-annotation-train.csv'
    pairs_file_train = '/home/pose/fashion_data/fashion-resize-pairs-train.csv'
