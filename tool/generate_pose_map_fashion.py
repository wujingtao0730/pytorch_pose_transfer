...
MISSING_VALUE = -1
# fix PATH
img_dir = '/home/pose/fashion_data'  # raw image path
annotations_file = '/home/pose/fashion_data/fashion-resize-annotation-train.csv'  # pose annotation path
save_path = '/home/pose/fashion_data/testK'  # path to store pose maps
